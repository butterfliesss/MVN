...
def proc_emoset(dirt, phaselist, emoset, min_count, max_seq_len):
	...
	saveToPickle("Data/" + emoset + "/" +emoset + '_tr_emodict.pt', tr_emodict)
	...
	emo_path = "Data/" + emoset + "/" + emoset + '_data.pt'
...
def main():
	...
	parser.add_argument('-emoset', type=str, default="IEMOCAP6")#  MELD
